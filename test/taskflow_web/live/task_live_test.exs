defmodule TaskflowWeb.TaskLiveTest do
  use TaskflowWeb.ConnCase

  import Phoenix.LiveViewTest
  import Taskflow.TasksFixtures

  @create_attrs %{priority: "some priority", status: "some status", description: "some description", title: "some title", due_date: "2024-12-06"}
  @update_attrs %{priority: "some updated priority", status: "some updated status", description: "some updated description", title: "some updated title", due_date: "2024-12-07"}
